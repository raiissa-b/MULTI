...
int _main (int argc, char *argv[])
{
    ...
    size_t  icache_ways     	= 1;	// instruction cache number of associative ways per set
    ...
    segtable.addSegment("seg_tty"    , SEG_TTY_BASE    , SEG_TTY_SIZE   , RAM_INDEX, true);
    ...
    /*ici on veut les cheminons : sys.bin et app.bin peut être sans ""*/	
